    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">Análisis financiero y clínico del sistema</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <div className="flex flex-col md:flex-row gap-4 items-end">
            ...
            <button
              ...
              disabled={loading}
              className="px-6 py-2 bg-blue-500 hover:bg-blue-600 disabled:bg-blue-300 text-white font-semibold rounded-lg transition-colors"
            >
        ...
        {activeTab === 'financiero' && reporteFinanciero && (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className={`bg-white rounded-lg shadow-lg p-6 border-l-4 ${reporteFinanciero.resumen.utilidad >= 0 ? 'border-emerald-500' : 'border-red-500'}`}>
                <div className="flex items-center justify-between">
                  <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-4">Facturas por Estado</h3>
            ...
            {/* Top Pacientes */}
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-bold text-slate-900 mb-4">Top 10 Pacientes por Gasto</h3>
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-slate-200">
                      <th className="text-left py-3 px-4 font-semibold text-slate-700">Paciente</th>
                      <th className="text-right py-3 px-4 font-semibold text-slate-700">Total Gastado</th>
                      <th className="text-right py-3 px-4 font-semibold text-slate-700">Porcentaje</th>
                    </tr>
                  </thead>
                  <tbody>
                        ...
                        <tr key={index} className="border-b border-slate-100 hover:bg-slate-50">
                          ...
                          <td className="py-3 px-4 text-right">
                            <div className="flex items-center justify-end gap-2">
                              ...
                              <span className="text-sm text-slate-600">{porcentaje.toFixed(1)}%</span>
                            </div>
                          </td>
                        </tr>
                      )
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h4 className="font-semibold text-slate-900 mb-4">Facturas</h4>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h4 className="font-semibold text-slate-900 mb-4">Flujo de Caja</h4>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-slate-600">Total Facturas:</span>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h4 className="font-semibold text-slate-900 mb-4">Egresos</h4>
                <div className="space-y-2">
                  <div className="flex justify-between">
        ...
        {activeTab === 'clinico' && reporteClinico && (
          <div className="space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-slate-900 mt-2">{reporteClinico.resumen.citasTotal}</p>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-green-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-slate-900 mt-2">{reporteClinico.resumen.pacientesAtendidos}</p>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-purple-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-slate-900 mt-2">{reporteClinico.resumen.tasaAsistencia.toFixed(1)}%</p>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-orange-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-slate-900 mt-2">{reporteClinico.resumen.procedimientosRealizados}</p>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Citas por Estado */}
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-4">Citas por Estado</h3>
                <ResponsiveContainer width="100%" height={300}>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-4">Tratamientos por Estado</h3>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie
            ...
            {/* Top Procedimientos */}
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-bold text-slate-900 mb-4">Top Procedimientos Realizados</h3>
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-slate-200">
                      <th className="text-left py-3 px-4 font-semibold text-slate-700">Procedimiento</th>
                    ...
                    {reporteClinico.procedimientos.topProcedimientos.map((proc, index) => {
                      ...
                      return (
                        <tr key={index} className="border-b border-slate-100 hover:bg-slate-50">
                          ...
                          <td className="py-3 px-4 text-right font-semibold text-slate-900">{proc.cantidad}</td>
                          <td className="py-3 px-4 text-right">
                            <div className="flex items-center justify-end gap-2">
                              <div className="w-24 bg-slate-200 rounded-full h-2">
                                <div
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h4 className="font-semibold text-slate-900 mb-4">Citas</h4>
                <div className="space-y-2">
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    <span className="text-slate-600">No Asistió:</span>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h4 className="font-semibold text-slate-900 mb-4">Tratamientos</h4>
                <div className="space-y-2">
                  <div className="flex justify-between">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h4 className="font-semibold text-slate-900 mb-4">Procedimientos</h4>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-slate-600">Total:</span>
